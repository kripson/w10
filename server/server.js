...
MongoClient.connect(url, {poolSize:10,useNewUrlParser: true,useUnifiedTopology: true},function(err, client) {
    ...
    if (err) {return console.log(err)}
        ...
        require('./app/api-add.js')(db,app);
        //require('./routes/api-prodcount.js')(db,app);
        require('./app/api-validid.js')(db,app);
        //require('./routes/api-getlist.js')(db,app);
        require('./app/api-getitem.js')(db,app,ObjectID);
        require('./app/api-update.js')(db,app,ObjectID);
        require('./app/api-deleteitem.js')(db,app,ObjectID);
